...
@Component({
  selector: 'app-all-health-packages',
  templateUrl: './all-health-packages.component.html',
  styleUrl: './all-health-packages.component.scss'
})
export class AllHealthPackagesComponent implements OnInit {
  ...
  @ViewChild('allPckgMdl') allPckgMdl!: ElementRef;
  @ViewChild('includsMdl') includsMdl!: ElementRef;
  ...
  addLabTest(productObj: any) {
    ...
    if(canAdd == true){
      ...
      if(this.alertMsg != ''){
        this.allPckgMdl.nativeElement.click();
      }
    }
  }
  ...
  viewIncluded(dts: any){
    this.testIncluded = dts;
    this.includsMdl.nativeElement.click();
  }
