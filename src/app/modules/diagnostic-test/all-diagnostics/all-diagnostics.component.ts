...
@Component({
  selector: 'app-all-diagnostics',
  templateUrl: './all-diagnostics.component.html',
  styleUrl: './all-diagnostics.component.scss'
})
export class AllDiagnosticsComponent implements OnInit {
