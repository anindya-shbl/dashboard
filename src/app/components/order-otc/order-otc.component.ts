...
@Component({
  selector: 'app-order-otc',
  templateUrl: './order-otc.component.html',
  styleUrl: './order-otc.component.scss'
})

export class OrderOtcComponent implements OnInit {
            ...
            this.imageArr.push(
              {
                ...
                "ProductImage": "https://asset.sastasundar.com/incom/images/product/thumb/Household.svg",
                "DisplaySeq": 1,
                "ProductBigImageUrl": "https://asset.sastasundar.com/incom/images/product/thumb/Household.svg"
              }
            )
          }
