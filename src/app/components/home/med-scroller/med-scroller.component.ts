...
@Component({
  selector: 'app-med-scroller',
  templateUrl: './med-scroller.component.html',
  styleUrl: './med-scroller.component.scss'
})
export class MedScrollerComponent implements OnInit {
